...
const CitySelector = memo(function CitySelector(props) {
    ...
    const outputCitySections = () => {
        ...
        if (cityData) {
            return (
                <CityList
                    secionts={cityData.cityList}
                    select={select}
                    AlphabetClick={AlphabetClick}
                />
            );
        }
    };
...
const CitySection = memo(function CitySection(props) {
    ...
    return (
        <ul className="city-ul">
            <li className="city-li" data-key={title}>
                {title}
            </li>
            {citys.map((ele) => {
                return (
                    <CityItem name={ele.name} key={ele.name} select={select} />
                );
            })}
        </ul>
    );
...
const CityItem = memo(function CityItem(props) {
    ...
    return (
        <li className="city-li" onClick={() => select(name)}>
            {name}
        </li>
    );
});
...
const AlphaIndex = memo(function AlphaIndex(props) {
    ...
    return (
        <i className="city-index-item" onClick={() => AlphabetClick(alpha)}>
            {alpha}
        </i>
    );
});
