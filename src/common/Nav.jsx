...
export default function Nav(props) {
  ...
  return (
    <div className='nav'>
      <span className={classnames('nav-prev', { 'nav-disabled': isPrevDisable })} onClick={prev}>前一天</span>
      <span className='nav-current'>
        {currentTime}
      </span>
      <span className={classnames('nav-next', { 'nav-disabled': isNextDisable })} onClick={next}>后一天</span>
    </div>
  )
}
