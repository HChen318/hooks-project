            ...
            <div className="bottom-filters">
                ...
                <span
                    className={classnames('item', {
                        'item-on': !noChecked || isFiltersVisible,
                    })}
            ...
            <ul>
                {options.map((ele) => (
                    <OptionItem
                        key={ele.value}
                        {...ele}
                        checked={ele.value in checkedMap}
                        dispatch={dispatch}
                    />
                ))}
            </ul>
