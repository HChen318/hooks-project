...
function App(props) {
  ...
  useEffect(() => {
    let { aStation, dStation, trainNumber, date } = URI.parseQuery(window.location.search)
  ...
  }, [departDate, departStation, arriveStation, trainNumber])
  ...
  const {
    ...
    isNextDisable,
    prev,
    next } = useNav(departDate, prevDate, nextDate, dispatch)
