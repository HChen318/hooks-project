...
function ScheduleRow(props) {
    const {
        ...
        isEndStation,
        isArriveStation,
        isArriveStationAfter,
        isDeaprtStation,
        isDepartStationBefore,
        isStartStation,
        station,
        stay,
        index,
        ...
        <li>
            ...
            <div
                className={classNames('row', {
                    grey: isArriveStationAfter || isDepartStationBefore,
                })}
            >
                <span
                    className={classNames('station', {
                        red: isDeaprtStation || isArriveStation,
                    })}
                >
                    {station}
                </span>
                <span
                    className={classNames('arrtime', { red: isArriveStation })}
                >
                    {isStartStation ? '始发站' : arriveTime}
                </span>
                <span
                    className={classNames('deptime', { red: isDeaprtStation })}
                >
